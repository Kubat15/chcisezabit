...
public partial class NewPage1 : ContentPage
{
    ...
    public void ShowRandomImage()
    {
        ...
        // vytvoøte list odpovìdí, kde první odpovìï je správná
        ...
        for (int i = 0; i < 3; i++)
        {
            var randomAnswer = allChampions[new Random().Next(allChampions.Count)];
            allChampions.Remove(randomAnswer);
            answers.Add(randomAnswer);
        }

        // náhodnì zamíchejte odpovìdi
